# deployments/kubernetes/aws/main.tf
terraform {
  required_providers {
    aws = {
      source  = "hashicorp/aws"
      version = "~> 6.0" # Updated to latest major version
    }
  }
}
...
resource "aws_eks_cluster" "this" {
  ...
  # Enable cluster control plane logging
...
resource "aws_iam_role_policy_attachment" "eks_cluster_policy" {
  ...
  role       = aws_iam_role.eks_cluster_role.name # Fixed: changed from role_name to role
}

# Note: AmazonEKSServicePolicy is deprecated and no longer needed
...
resource "aws_iam_role_policy_attachment" "eks_node_policy_AmazonEKSWorkerNodePolicy" {
  ...
  role       = aws_iam_role.eks_node_role.name # Fixed: changed from role_name to role
}
